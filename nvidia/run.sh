...
LIBRARY_PATHS="/opt/nvidia/lib /opt/nvidia/lib32"
...
deactivate_gpu() {
	...
	# only do this if there were no errors or the error occured after module loading
	if [[ $error -lt 3 ]]; then
		# unload modules
